                                ...
                                ? List.generate(data.searchNews.length,
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        Center(
                                          child: Text(
                                              data.searchNews[index].Title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),),
                                        ),
                                        Center(
                                            child: Text(
                                        ...
                                        Text(
                                            data.searchNews[index].Description, style: const TextStyle(fontWeight: FontWeight.w300),),
                                            const SizedBox(
                                          height: 10,
                                        ),
                                        Text(data.searchNews[index].content, style: const TextStyle(fontWeight: FontWeight.w300), ),
                                        const SizedBox(
                                          height: 20,
                                        ),
                                        Center(
                                          child: Text(
                                              data.searchNews[index].publishedAt),
                                        ),
                                        const SizedBox(
                                          height: 20,
                                        ),
